...
public class AgregarAmigos extends AppCompatActivity {
    ...
    Button btn;
    com.grupo6.agendadb.DB miBD;
    TextView tempVal;
    com.grupo6.agendadb.utilidades miUrl;
    com.grupo6.agendadb.detectarInternet di;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        miBD = new com.grupo6.agendadb.DB(getApplicationContext(),"",null,1);
        ...
        btn.setOnClickListener(v->{
            try {
                ...
                di = new com.grupo6.agendadb.detectarInternet(getApplicationContext());
